...
export async function GET(request:NextRequest){
 ...
 try{
  ...
  const [members,residents,ranks,orders,sessions,unpaid,stripe,failures,tasks,communications,todayOrders,todayStudio,todayMembers,activeStudio,urgentTasks,posMissing,inventory,latestWebhook,staleResidents]=await Promise.all([
